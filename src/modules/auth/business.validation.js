...
const validateBusinessUpdateProfile = [
  body('username')
    .optional()
    .trim()
    .isLength({ min: 3, max: 30 }).withMessage('Username must be between 3 and 30 characters')
...
const validateBusinessChangePassword = [
...
module.exports = {
  ...
  validateBusinessUpdateProfile,
  validateBusinessChangePassword
};
